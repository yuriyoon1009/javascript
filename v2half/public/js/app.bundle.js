...
(function () {
    ...
    document.querySelector('.nav').addEventListener('click', function (e) {
        ...
        [].concat(_toConsumableArray(this.childNodes)).forEach(function (ulChild) {
    ...
    var toggleComplete = function toggleComplete(checkBoxId) {
        var _todos$find = todos.find(function (_ref3) {
            var id = _ref3.id;
            return id == checkBoxId;
        }),
            completed = _todos$find.completed;

        _axios2.default.patch('/todos/' + checkBoxId, { completed: !completed }).then(function (res) {
            getTodos();
        }).catch(function (err) {
            return console.log(err.response);
        });
    ...
    var selectedLabel = function selectedLabel(num, colourLabel) {
        //return colourLabel;
        // num = 3
        return colourLabel;
    };

    var setLabelColor = function setLabelColor(inputId) {
        var _todos$find2 = todos.find(function (_ref4) {
            var id = _ref4.id;
            return id == inputId;
        }),
            label = _todos$find2.label;

        _axios2.default.patch('todos/' + inputId, { label: selectedLabel(inputId) }).then(function (res) {
            getTodos();
        }).catch(function (err) {
            return console.log(err.response);
        });
    ...
    */
    ...
    var addTodo = function addTodo() {
        ...
        if (!todos || todos.length == 0) {
            // content : content  es6
            todo = { id: 1, content: content, completed: false, label: 'red' };
        } else {
            todo = { id: lastTodoId(), content: content, completed: false, label: 'blue' };
    ...
    var toggleTodoComplete = function toggleTodoComplete(id) {
        ...
        //render();
        var todoSelected = void 0;
        todoSelected = todos.find(function (todo) {
        ...
        var todoCompleted = { completed: !todoSelected.completed };

        _axios2.default.patch('/todos/' + id, todoCompleted).then(function (res) {
            //console.log('[EDIT]\n',);
            getTodos();
        }).catch(function (err) {
            return console.log(err.response);
